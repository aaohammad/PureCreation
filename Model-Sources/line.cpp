...
Line::Line(QList<Vector> vertices)
{
...
void Line::drawEdgeSelectMode()
{

}

void Line::drawFaceSelectMode()
{

}

void Line::drawObjectSelectMode()
{
    glPushMatrix();
    //between push matrix
...
void Line::drawVertexSelectMode()
{
...
void Line::reflect(float m, float n)
{
    int i = 0;
...
void Line::vertexComboBoxChanged()
{
    char f = 'f';
