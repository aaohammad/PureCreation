...
**
** Created: Thu Jun 2 19:00:22 2011
...
static const char qt_meta_stringdata_Polygon[] = {
    "Polygon\0\0changeAttributes()\0changeColorAE()\0"
    "vertexComboBoxChanged()\0"
};

const QMetaObject Polygon::staticMetaObject = {
    { &Model::staticMetaObject, qt_meta_stringdata_Polygon,
      qt_meta_data_Polygon, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Polygon::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Polygon))
